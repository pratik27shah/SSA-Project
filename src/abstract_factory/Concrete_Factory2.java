 ...
 * 
 * */
public class Concrete_Factory2 implements abstract1 {
	Incorrect_Pin_msg incorrect_pin = new Incorrect_Pin_msg_Account2();
	datastore objdatastore = new datastore_Account2();
	Prompt_for_Pin objPrompt_for_Pin = new Prompt_for_Pin_Account2();
	Too_many_Attempts objCreateTooManyAttemptsMsg = new Too_many_Attemtps_Account2();
	DisplayMenu objDisplayMenu = new DisplayMenu_Account2();
	Store_pin objStore_pin = new Store_pin_Account2();
	Store_Balance objStore_Balance = new Store_Balance_Account2();
	Store_uid objStore_uid = new Store_uid_Account2();
	Display_Balance objDisplay_Balance = new Display_Balance_account2();
	Make_Deposit objMake_Deposit = new Make_Deposit_Account2();
	Make_Withdrawn objMake_Withdrawn = new Make_Withdrawn_Account2();
	Display_Pin objDisplay_Pin = new Display_Pin_Account2();
	Display_uid objDisplay_uid = new Display_uid_Account2();
	Incorrect_Id_message objIncorrect_Id_message = new Incorrect_Id_msg_Account2();
	No_Fund_message objNo_funds = new No_Fund_message_Account2();
	Incorrect_unlock_msg objIncorrect_unlock_msg = new Incorrect_unlock_msg_Account2();
	Incorrect_lock objIncorrect_lock = new Incorrect_lock_Account1();
	penalty objpPenalty = new penalty_Account1();
Log_out objLog_out=new Log_out_Account2();
...
/*Purpose:returns obj of the uid to store it
 * 
 **/
public Store_uid CreateStoreUid() {
	return this.objStore_uid;
}
/*Purpose:returns obj to display balance
 * 
 **/
